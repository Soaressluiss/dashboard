...
export default function FavTransfer() {
  return (
    <section className="  w-[370px] md:w-[412.47px] h-[245.36px] p-6 bg-white flex flex-col gap-5 rounded-md mb-3">
      <article className="w-[324.96px] h-[29px] flex  justify-between items-center ">
        <h4 className="text-light-gray-900 md:text-xl font-bold font-manrope leading-[28.98px]">Favourite Transfers</h4>

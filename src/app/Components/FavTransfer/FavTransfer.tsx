...
export default function FavTransfer() {
  return (
    <section className=" w-full min-w-[17rem] md:max-h-[11.8rem] laptop:max-h-[246px] p-6 bg-white dark:bg-dark-primaryBlue flex flex-col gap-3 laptop:gap-5 rounded-md">
      ...
      <div className=" w-full h-[50px] laptop:h-[61.82px] flex items-center gap-x-4 px-5 py-3 rounded-md border border-gray-200">
        <Image src={Avatar01} 
        sizes="(max-width: 789px) 39px"
        
        height={39}  alt="avatar" />
        <p className="text-light-gray-800 dark:text-dark-white text-sm md:text-base font-bold font-manrope leading-[23.18px]">
          Kathryn Murphy
        </p>
      </div>
      <div className="w-full h-[50px] laptop:h-[61.82px] flex items-center gap-x-4 px-5 py-3 rounded-md border border-gray-200">
        <Image src={Avatar02} sizes="(max-width: 789px) 39px" height={39} alt="avatar" />
        <p className="text-light-gray-800  dark:text-dark-white text-sm md:text-base font-bold font-manrope leading-[23.18px]">
          Wade Warren
        </p>
      </div>

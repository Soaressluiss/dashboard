...
export default function Balance() {
  ...
  return (
    <section className=" relative w-[300px] smPhone:w-[490px] md:w-[700px] laptop:w-[412.47px] h-[193.19px] bg-white dark:bg-dark-primaryBlue after:content-imageBalance after:inline-block after:absolute after:right-0 after:bottom-0  rounded-md p-[23px] flex flex-col gap-6">
